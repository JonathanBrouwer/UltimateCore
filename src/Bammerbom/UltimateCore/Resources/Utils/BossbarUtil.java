...
public class BossbarUtil implements Listener {
    ...
    public static void enable() {
        ...
        enabled = true;
        Bukkit.getServer().getPluginManager().registerEvents(new BossbarUtil(), UltimateCore.getPlugin());
        Bukkit.getServer().getScheduler().scheduleSyncRepeatingTask(UltimateCore.getPlugin(), new Runnable() {
            public void run() {
    ...
    public static void setMessage(final Player player, String message, int seconds) {
        ...
        timers.put(player.getUniqueId(), Integer.valueOf(Bukkit.getScheduler().runTaskTimer(UltimateCore.getPlugin(), new Runnable() {
            public void run() {
    ...
    private void handleTeleport(final Player player, final Location loc) {
        ...
        Bukkit.getScheduler().runTaskLater(UltimateCore.getPlugin(), new Runnable() {
            public void run() {
                if (!hasBar(player)) {
                    return;
                }
